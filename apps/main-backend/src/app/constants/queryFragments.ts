export const QueryFragments = {
  ...
  BASE_USER_PROFILE: `id,surname,other_names,phone,access_granted,last_login_at,created_at,deleted_at`,
  BASE_STAFF: `id,user_id,branch_id,role,address,notes,created_at,updated_at,deleted_at`,
