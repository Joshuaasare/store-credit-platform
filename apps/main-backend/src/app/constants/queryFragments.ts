export const QueryFragments = {
  ...
  BASE_BRANCH: `id,merchant_id,name,phone,address,city,country_code,is_active,created_at,updated_at,deleted_at,latitude,longitude,place_id,place_label,category`,
