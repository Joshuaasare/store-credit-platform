export const QueryFragments = {
  ...
  BASE_RUNNING_CREDIT_CONFIG: `id,click_count,credit_type,images,credit_validity,eligible_window,fixed_credit_value,percentage_credit_value,maximum_allowed_credit,threshold_amount,terms,cumulative_scope,is_active,created_at,updated_at,deleted_at,url`,
  BASE_FIXED_CREDIT_CONFIG: `id,click_count,title,description,images,start_date,end_date,terms,is_active,created_at,updated_at,deleted_at,url`,
} as const;
